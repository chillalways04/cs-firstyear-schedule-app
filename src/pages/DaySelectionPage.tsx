        ...
        <div className="max-w-sm mx-auto">
          ...
          <Card className="shadow-2xl border-0 bg-white/95 backdrop-blur-sm rounded-3xl overflow-hidden">
            <CardHeader className="text-center pb-6 pt-8 px-6">
              <CardTitle className="text-xl md:text-2xl font-bold text-gray-800 flex items-center justify-center gap-3">
              ...
              <div className="grid grid-cols-1 gap-3">
                {daysOfWeek.map((day) => (
                  <Button
                    key={day}
                    variant="ghost"
                    className="h-16 text-lg font-semibold bg-gray-50/80 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:text-white border-2 border-gray-200 hover:border-transparent transition-all duration-300 rounded-2xl shadow-sm hover:shadow-lg active:scale-95"
